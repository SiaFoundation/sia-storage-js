...
// End-to-end proof that a published tarball can be installed and used
// from both Node and Bun. Packs the package, installs it into an isolated
// temp project, stages the NAPI binary that CI-or-local built, and runs
// src/tests/fixtures/node-smoke.mjs under both runtimes. Passes if the
// smoke script runs to completion.
