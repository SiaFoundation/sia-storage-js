...
describe('esbuild bundler integration', () => {
  ...
  beforeAll(async () => {
    ...
    // esbuild leaves the new URL("sia_storage_wasm_bg.wasm", import.meta.url)
    // reference in the output but doesn't copy the .wasm itself. Real-world
    // setups copy the file explicitly. Documenting this in the README.
    cpSync(
